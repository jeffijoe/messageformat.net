...
namespace Jeffijoe.MessageFormat.Parsers
{
    /// <summary>
    ...
    public class MalformedLiteralException : Exception
    {
        ...
        internal MalformedLiteralException(string message, int lineNumber, int columnNumber, string sourceSnippet = null) : base(BuildMessage(message, lineNumber, columnNumber, sourceSnippet))
        {
